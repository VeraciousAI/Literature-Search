...
from ucl_discovery import search_discovery
from arxiv_loader import search_arxiv
...
def Search(query, SS_key):
    semantic_titles, semantic_authors, semantic_years, semantic_links, semantic_abstracts, semantic_journals, semantic_dois = SemanticScholarLoader(SS_key).search_semantic(query)
    
    ucl_titles, ucl_authors, ucl_years, ucl_links, ucl_abstracts, ucl_journals, ucl_dois = search_discovery(query)
    
    arxiv_titles, arxiv_authors, arxiv_years, arxiv_links, arxiv_abstracts, arxiv_journals, arxiv_dois = search_arxiv(query)
    
    springer_titles, springer_authors, springer_years, springer_links, springer_abstracts, springer_journals, springer_dois = search_springer(query)
    ...
    #citation_counts = [semantic_citation_count]
